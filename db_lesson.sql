...
SELECT * FROM reports;
+-----------+-----------+-----------------------------------------------------------------------+---------------------+
| report_id | person_id | content                                                               | created_at          |
+-----------+-----------+-----------------------------------------------------------------------+---------------------+
|         1 |         1 | 今日はデータベースの学習をした                                        | 2025-03-27 00:00:00 |
|         2 |         2 | クライアント対応のための資料を作成しました                            | 2025-03-27 00:00:00 |
|         3 |         3 | 今後のプロジェクト計画をチームで話し合いました                        | 2025-03-27 00:00:00 |
|         4 |         4 | マーケティング施策の分析結果を共有しました                            | 2025-03-27 00:00:00 |
|         5 |         5 | 開発中の新機能のテストを実施しました                                  | 2025-03-27 00:00:00 |
|         6 |         6 | 財務報告書の作成とレビューを行いました                                | 2025-03-27 00:00:00 |
|         7 |         7 | 社内研修の準備を進めました                                            | 2025-03-27 00:00:00 |
|         8 |         8 | 新しいシステム導入について提案をまとめました                          | 2025-03-27 00:00:00 |
|         9 |         9 | 社内ネットワークのメンテナンスを行いました                            | 2025-03-27 00:00:00 |
|        10 |        10 | 人事評価制度の見直しについて議論しました                              | 2025-03-27 00:00:00 |
|        11 |        11 | NULL                                                                  | 2025-03-27 17:15:31 |
+-----------+-----------+-----------------------------------------------------------------------+---------------------+
11 rows in set (0.01 sec)

※created_atは追加データの記述を必要としない理由として、システム側が自動入力をするため。
例：contentの中身を変更した場合、自分が変更日を入力しなくても、システムが変更日を入力してくれる。
